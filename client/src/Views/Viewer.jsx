    ...
    return (
        ...
        {!isLoading && ( 
            <div className='w-full flex justify-center'>
                ...
                <button className='absolute bottom-4 right-4 sm:hidden rounded-full w-20 h-20 bg-gradient-to-br from-yellow-500 to-yellow-600 shadow-md shadow-black/50 flex justify-center items-center' onClick={() => {setMapSize({})} }>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-map-fill w-8 h-8 text-slate-800" viewBox="0 0 16 16">
