...
const ExpansionSelect = (props) => {
    ...
    return (
        <button 
        onClick={() => {handleDispatch(); setEffect(!effect) } } 
        className={`rounded-3xl text-center lg:w-1/6 hover:scale-105 transition-all flex justify-center items-start expansions ` + (effect && (` animate-expand`))}
