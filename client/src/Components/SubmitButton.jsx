...
const SubmitButton = (props) => {
    ...
    function handleGuess() {
        ...
        //If within correct zone, give points and use setPoints to reflect in modal
        if (mapLevel === gameState.currentLocation.zone.shortName) {
            ...
            dispatch({type: "setPoints", value: 0})
        }
    ...
    return (
        <>
            <div className="w-full leaflet-bottom leaflet-left ">
