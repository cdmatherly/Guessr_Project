...
const Navbar = (props) => {
    ...
    <div className="relative">
        ...
        <div class={`w-full sm:hidden absolute duration-200 bottom-0 ` + (isClosed? ` -translate-y-48` : ` translate-y-10`)} id="navbar-solid-bg">
            <ul class="flex flex-col items-end font-medium mt-4 rounded-lg bg-gray-50 space-x-8 border-0 bg-transparent dark:bg-gray-800 dark:bg-transparent dark:border-gray-700">
                <li>
                <Link to="/about" class="inline-block py-2 pl-3 pr-4 text-white rounded bg-transparent p-0 bg-gradient-to-br from-slate-800 to-slate-900 " aria-current="page">About</Link>
                </li>
            </ul>
        </div>
    </div>
